		...
		<form class="layui-form">
			...
			<div class="layui-form-item" pane>
				<span> <input class="layui-btn" type="reset" value="重置" /> <input
					...
					<input class="layui-btn" type="button" onclick="openUserAdd()"
					value="添加" /> <input class="layui-btn" type="button"
					onclick="exportExcel()" value="导出Excel" /> <input
					class="layui-btn" type="button" onclick="exportExcelTpl()"
					value="下载模板" /> <input class="layui-btn" id="test4" type="button"
					value="上传文件" />
				</span>
			</div>
...
<input type='button' class='layui-btn' onclick='openUserPas("{{d.userCode}}")' value='重置密码' />
	...
	<script type="text/javascript">
		...
		function exportExcelTpl() {
			window.location.href = con.app + '/user/exportExcelTpl';

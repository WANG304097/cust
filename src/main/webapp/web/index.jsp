...
<head>
    ...
    <link rel='Shortcut Icon' type='image/x-icon' href='/mis/web/win10/img/windows.ico'>
    <script type="text/javascript" src="/mis/web/win10/js/jquery-2.2.4.min.js"></script>
    <link href="/mis/web/win10/css/animate.css" rel="stylesheet">
    <script type="text/javascript" src="/mis/web/win10/component/layer-v3.0.3/layer/layer.js"></script>
    <link rel="stylesheet" href="/mis/web/win10/component/font-awesome-4.7.0/css/font-awesome.min.css">
    <link href="/mis/web/win10/css/default.css" rel="stylesheet">
    <script type="text/javascript" src="/mis/web/win10/js/win10.js"></script>
    ...
    <script>
        Win10.onReady(function () {
            ...
            //设置壁纸
            Win10.setBgUrl({
                main:'/mis/web/win10/img/wallpapers/main.jpg',
                mobile:'/mis/web/win10/img/wallpapers/mobile.jpg',
            });
        ...
        function win10_forgive_me() {
            ...
            layer.alert('点击展示下一版本特性', {}, function(index){
                var blue=$('<img src="/mis/web/win10/img/presentation/bluescreen.jpg" style="position: fixed;width: 100%;height:100%;top:0;z-index:9999999999" />');
                setTimeout(function () {
                    $('body').append(blue);
                },3000);
                setTimeout(function () {
...
<div id="win10">
    <div class="desktop">
        <div id="win10-shortcuts" class="shortcuts-hidden">
            ...
            <div class="shortcut" onclick='Win10.openUrl("/mis/user/userList.do","<i class=\"fa fa-user icon black-green\"></i>员工信息管理")'>
                <i class="fa fa-user icon black-green"></i>
                <div class="title">员工信息</div>
            </div>
            <div class="shortcut" onclick='Win10.openUrl("/mis/role/roleList.do","<i class=\"fa fa-user icon black-green\"></i>职位信息管理")'>
                <i class="fa fa-user icon black-green"></i>
                <div class="title">职位信息</div>
            </div>
            <div class="shortcut" onclick='Win10.openUrl("/mis/menu/menuList.do","<i class=\"fa fa-user icon black-green\"></i>菜单信息管理")'>
                <i class="fa fa-user icon black-green"></i>
                <div class="title">菜单信息</div>
            </div>
            <div class="shortcut" onclick='Win10.openUrl("/mis/menu/menuList.do","<i class=\"fa fa-user icon black-green\"></i>权限信息管理")'>
                <i class="fa fa-user icon black-green"></i>
    ...
    <div id="win10-menu" class="hidden">
        <div class="list win10-menu-hidden animated animated-slideOutLeft">
            ...
            <div class="sub-item" onclick="Win10.openUrl('/mis/web/win10/child.html','子页')">父子页沟通</div>
            ...
            <div class="item" onclick="layer.open({
                ...
                offset:'50px',
                shadeClose:true,
                content: '<img width=\'300\' src=\'/mis/web/win10/img/presentation/donation.jpg\' />'
        ...
        <div class="blocks">
            <div class="menu_group">
                ...
                <div loc="1,1" size="6,3" class="block">
                    ...
                    <div class="content red cover">
                        <img width="264" style="position: relative;top: -50px;" src="/mis/web/win10/img/presentation/wangyiyun.gif" />
                    </div>
                </div>
            ...
            <div class="menu_group">
                ...
                <div loc="5,2" size="2,2" class="block">
                    <div class="content">
                        <img style="width: 40px;height: 40px;margin: 5px auto;display: block" src="/mis/web/win10/img/icon/baidu.png">
                        <div class="win10-block-content-text">图标按钮</div>
                    </div>
                </div>
                <div loc="1,4" size="6,3" class="block">
                    <div class="content" style="background: url('/mis/web/win10/img/presentation/1.png');background-size: auto">
